...
const server_url = process.env.NODE_ENV === 'production' ? 'https://my-microsoft-teams-clone.herokuapp.com/' : "http://localhost:4001"
				...
				{this.state.askForUsername === true ?
					<div>
						<div style={{
							...
							<p style={{ margin: 0, fontWeight: "bold", paddingRight: "50px", color: "#4b53bc" }}>Set your username</p>
					...
					:
					<div>
						<div className="btn-down" style={{ backgroundColor: "whitesmoke", color: "whitesmoke", textAlign: "center", padding: "10px 0" }}>
						...
						<Modal show={this.state.showModal} onHide={this.closeChat} style={{ zIndex: "999999" }}>
							<Modal.Header closeButton>
								<Modal.Title><p style={{ color: "#4b53bc", fontWeight: "500" }}>Chat</p></Modal.Title>
							</Modal.Header>
